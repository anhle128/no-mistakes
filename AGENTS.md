...
- **Learn from mistakes**: when you make a mistake (wrong assumption, bad recommendation, missed context, etc.), log it to `brain/Gotchas.md` with: what happened, why it went wrong, and the rule to prevent it next time. Link to relevant context. Read `brain/Gotchas.md` at session start to avoid repeating past mistakes.
...
- `specs/002-review-resolution-report/plan.md`
<!-- SPECKIT END -->
