...
- When review-resolution report metadata exists, or review fix rounds ran, the regenerated `## Pipeline` section starts with the report path, status, latest outcome, compact counts, and up to three sanitized review fix summaries
